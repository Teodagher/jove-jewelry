import { Shield, Monitor, Gem, Truck, RotateCcw, MessageCircle } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6">
            <div className="flex justify-center mb-3">
              <RotateCcw className="w-8 h-8 text-zinc-600" strokeWidth={1.5} />
            </div>
          ...
          <div className="text-center p-6">
            <div className="flex justify-center mb-3">
              <MessageCircle className="w-8 h-8 text-zinc-600" strokeWidth={1.5} />
            </div>
