      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-maison-graphite leading-relaxed">
              ...
              <div className="block md:hidden space-y-4">
                <p className="text-base font-light">
                  My name is Joey Germani, and jewellery has been in my life from a young age.
                </p>
                <p className="text-sm font-light text-maison-graphite/80">
                  Growing up in a family of jewellers with 35+ years of expertise, I became a certified Diamond Grader in New York. 
                  That vision became Maison Jové — where true luxury meets accessibility.
                </p>
              </div>
              ...
              <div className="hidden md:block space-y-6">
                ...
                <p className="text-base font-light text-maison-graphite/80">
                  Growing up in a family of jewellers, I learned the art of craftsmanship at my father's factory, 
                  where he shared over 35 years of expertise in retail and manufacturing. By 18, I was working 
                  full-time in the family business, gaining hands-on knowledge of both jewellery and fashion.
                </p>
                
                <p className="text-base font-light text-maison-graphite/80">
                  At 21, I moved to New York and became a certified Diamond Grader, determined to bring my 
                  vision to life. That vision became Maison Jové — a brand where true luxury meets accessibility, 
            ...
            {/* Signature */}
            <div className="pt-4">
              <p className="font-serif text-2xl italic text-maison-charcoal">Joey Germani</p>
              <p className="text-xs text-maison-gold tracking-wider uppercase mt-1">Founder & Diamond Expert</p>
            </div>
          </motion.div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <blockquote className="mb-6">
                  <p className="font-serif text-lg md:text-xl font-light text-white leading-relaxed italic">
                    <span className="text-maison-gold text-3xl font-serif">“</span>
                    True luxury meets accessibility — designs perfected over generations.
                    <span className="text-maison-gold text-3xl font-serif">”</span>
                  </p>
                </blockquote>
                ...
                <div className="inline-flex items-center gap-3 bg-maison-black/30 backdrop-blur-sm border border-white/20 px-4 py-2">
                  <span className="text-maison-gold text-2xl font-serif font-light">35+</span>
                  <span className="text-xs text-white/80 tracking-wider uppercase">Years Family Legacy</span>
                </div>
              </div>
