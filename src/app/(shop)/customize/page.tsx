...
import MobileCustomizeGrid from '@/components/MobileCustomizeGrid';
...
export default function CustomizePage() {
  ...
  // Show mobile-native grid in PWA mode
  if (isStandalone) {
    return <MobileCustomizeGrid />;
  }

  // Desktop/regular mobile web experience
  return (
                      ...
                      <div className="relative aspect-[3/4] overflow-hidden bg-[#2d2d2d] rounded-lg shadow-2xl">
                        ...
                        {preset.badge_text && (
                          <div className="absolute top-4 left-4">
                            <span className={`inline-block px-3 py-1.5 text-xs tracking-widest uppercase font-medium rounded-full shadow-lg ${BADGE_STYLES[preset.badge_color || 'gold'] || BADGE_STYLES.gold
                              }`}>
                              {preset.badge_text}
                            </span>
                          </div>
