...
export default function NecklacesPricingPage() {
  ...
  const updateBasePriceGold = async (newPrice: number) => {
    try {
      setSaving(true);
      const success = await CustomizationService.updateBasePriceGold('necklace', newPrice);
  ...
  const updateBasePriceSilver = async (newPrice: number) => {
    try {
      setSaving(true);
      const success = await CustomizationService.updateBasePriceSilver('necklace', newPrice);
  ...
  const updateOptionPriceGold = async (settingId: string, optionId: string, newPrice: number) => {
    try {
      setSaving(true);
      const success = await CustomizationService.updateOptionPriceGold('necklace', settingId, optionId, newPrice);
  ...
  const updateOptionPriceSilver = async (settingId: string, optionId: string, newPrice: number) => {
    try {
      setSaving(true);
      const success = await CustomizationService.updateOptionPriceSilver('necklace', settingId, optionId, newPrice);
