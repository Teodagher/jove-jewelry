...
export default function AdminRingsPricingPage() {
  ...
  const groupedOptions = pricingData?.customization_options
    .filter(option => option.setting_id !== 'ring_size') // Exclude ring sizes from pricing
    .reduce((acc, option) => {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Pricing Management - Rings</h1>
